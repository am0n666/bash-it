...
function alias_completion {
    ...
    rm -f "/data/data/com.termux/files/usr/tmp/${namespace}-*.tmp" # preliminary cleanup
    local tmp_file; tmp_file="$(mktemp "/data/data/com.termux/files/usr/tmp/${namespace}-${RANDOM}XXX.tmp")" || return 1
